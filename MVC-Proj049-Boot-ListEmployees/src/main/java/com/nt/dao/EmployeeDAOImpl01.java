...
public class EmployeeDAOImpl01 implements EmployeeDAO {
	...
	public EmployeeDAOImpl01(JdbcTemplate jt) {
		this.jt = jt;
	}
	...
	public List<EmployeeBO> getEmps() {
		...
		listBO=jt.query(GET_EMPS,new ResultSetExtractor<List<EmployeeBO>>() {
