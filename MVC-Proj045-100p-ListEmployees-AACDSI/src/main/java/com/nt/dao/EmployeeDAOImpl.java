...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public List<EmployeeBO> getEmps() {
		...
		listBO=jt.query(GET_EMPS,new EmployeesExtractor(listBO));
		return listBO;
	}
	
	
	
	public static class EmployeesExtractor implements ResultSetExtractor<List<EmployeeBO>>{
		private List<EmployeeBO> listBos;

		public EmployeesExtractor(List<EmployeeBO> listBos) {
			this.listBos = listBos;
		}
